...
export default function App() {
  ...
  const [verseId, setVerseId] = useState("JER.29.11");
  ...
  function getNewVerse () {
    ...
    axios.get(`https://api.scripture.api.bible/v1/bibles/de4e12af7f28f599-01/search?query=${verseId}`, () => {
